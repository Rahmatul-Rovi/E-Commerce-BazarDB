...
export default function TrustBadges() {
  return (
    <section className="px-4 md:px-8 mt-14 mb-8">
      {/* গ্যাপ এবং ভেতরের প্যাডিং বাড়ানো হয়েছে (p-8, gap-8) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 bg-surface rounded-2xl p-8 border border-gray-100 shadow-md">
        {badges.map((badge) => (
          ...
          >
            {/* আইকন বক্স বড় করা হয়েছে (w-16 h-16) এবং আইকন সাইze ২৬ করা হয়েছে */}
            ...
            {/* টেক্সটের সাইজ বাড়িয়ে টাইটেল md এবং ডেসক্রিপশন sm করা হয়েছে */}
